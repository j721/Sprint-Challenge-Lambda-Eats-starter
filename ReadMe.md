...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    ...
    The useRouteMatch hook gives you the ability to add nested routes in your application, allowing you to change a single parameter in the URL without having to change the whole thing. 

    It attempts to match the current URL in the same way that a <Route> would, mostly used for gaining access to the match data. 


2. How would you explain form validation to someone who has never programmed before?

    Form validation is used to check and make sure the data submitted in the inputs matches the requirements made in the various form controls. 

3. In 1-2 sentences, define end to end testing. 

    End to end testing checks to see if the entire user experience on how a user would interact with an app is working correctly. If the user is able to accomplish an action on the app. 
